...
import { PlusIcon, FolderIcon, TimeIcon, UserCircleIcon } from '@/icons/index';
...
const InternalSidebar: React.FC<InternalSidebarProps> = ({ 
  ...
  return (
    <aside
      className={`flex flex-col bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-full transition-all duration-300 ease-in-out border-r border-gray-200
        ${
    ...
    >
      ...
      <div className="flex-none px-3 sm:px-5 py-4 border-t border-gray-200 dark:border-gray-800">
        <Link
          href="/settings"
          className={`w-full flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors ${
            !isExpanded && !isHovered ? 'justify-center' : 'justify-start'
          }`}
        >
          <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center">
