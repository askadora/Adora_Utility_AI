...
import { ProPlayToggleVertical } from "@/components/header/ProPlayToggleVertical";
...
const AppHeader: React.FC = () => {
  ...
  const [workMode, setWorkMode] = useState<'play' | 'pro'>('pro');
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-2 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-2.5">
          <button
        ...
        >
          <div className="flex items-center gap-1.5 2xsm:gap-2">
            ...
            {/* <!-- Company Switcher - Only show in Pro mode --> */}
            {workMode === 'pro' && <CompanySwitcher />}
            {/* <!-- Company Switcher --> */}
