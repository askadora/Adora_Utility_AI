          ...
          <div className="flex items-start justify-between">
            ...
            <div className="relative group flex-shrink-0 ml-6">
              ...
              <div className="absolute bottom-full right-0 mb-3 w-80 bg-gray-900 dark:bg-gray-700 text-white text-sm rounded-lg p-4 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">
                <div className="font-semibold text-purple-300 mb-2">🚀 Ask Adora for Startup Guidance</div>
                <div className="space-y-2 text-xs">
                  <div><strong>Metrics:</strong> "Show key performance indicators" or "Track growth metrics"</div>
                  <div><strong>Funding:</strong> "Prepare investor pitch deck" or "Calculate runway"</div>
                  <div><strong>Strategy:</strong> "Market analysis insights" or "Competitive positioning"</div>
                  <div><strong>Operations:</strong> "Scale team structure" or "Optimize burn rate"</div>
                </div>
