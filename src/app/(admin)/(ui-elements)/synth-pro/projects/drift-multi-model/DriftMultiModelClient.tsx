...
const mockProject = {
  ...
  description: "Advanced multi-model AI system for drift detection and analysis across different data streams and model outputs.",
  isPrivate: true,
  activities: [
    {
      id: 1,
      title: "Model Drift Detection Analysis",
      lastMessage: "Last message 2 hours ago"
    },
    {
      id: 2,
      title: "Multi-Model Performance Comparison",
      lastMessage: "Last message 4 hours ago"
    },
    {
      id: 3,
      title: "Drift Alert System Configuration",
  ...
  documents: [
    {
      id: 1,
      title: "Drift Detection Framework",
      lines: 456,
      type: "DOCX"
    },
    {
    ...
    {
      id: 6,
      title: "System Integration Specs",
      lines: 298,
      type: "DOCX"
    }
  ]
...
const PlusCircleIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM12 16H8V14H12V10H14V14H18V16H14V20H12V16Z" fill="currentColor"/>
  </svg>
);
...
const DriftMultiModelClient: React.FC = () => {
            ...
            <div className="max-w-4xl mx-auto w-full">
              <div className="mb-8 mt-16">
                <PromptInput 
                  ...
                  onChange={setInput}
                  onSubmit={handleSend}
                  placeholder="How can I help you with drift detection today?"
                  disabled={false}
                />
              </div>
        ...
        <div className="flex-none p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
            <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
              "You are a Data Scientist specializing in model drift detection and multi-model analysis... Edit"
            </p>
          </div>
        </div>
        ...
        <div className="flex-none p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-600 dark:text-gray-400">28% of project capacity used</span>
              <span className="text-gray-500 dark:text-gray-400">Analysis</span>
            </div>
...
export default DriftMultiModelClient; 