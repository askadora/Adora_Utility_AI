...
// Mock project data
const mockProject = {
  id: "cross-functionalities",
  title: "Cross Functionalities",
  description: "Analysis and optimization of cross-functional processes and system integrations across different departments and workflows.",
  isPrivate: true,
  activities: [
    {
      id: 1,
      title: "Department Integration Analysis",
      lastMessage: "Last message 1 hour ago"
    },
    {
      id: 2,
      title: "Workflow Optimization Study",
      lastMessage: "Last message 3 hours ago"
    },
    {
      id: 3,
      title: "Cross-Team Communication Framework",
  ...
  documents: [
    {
      id: 1,
      title: "Cross-Functional Process Map",
      lines: 342,
      type: "DOCX"
    },
    {
      id: 2,
      title: "Integration Requirements Matrix",
      lines: 278,
      type: "XLSX"
    },
    {
...
const CrossFunctionalitiesClient: React.FC = () => {
        ...
        <div className="flex-none p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
            <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
              "You are a Solutions Architect focused on cross-functional analysis... Edit"
            </p>
          </div>
        </div>
        ...
        <div className="flex-none p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-600 dark:text-gray-400">15% of project capacity used</span>
              <span className="text-gray-500 dark:text-gray-400">Mapping</span>
            </div>
...
export default CrossFunctionalitiesClient;