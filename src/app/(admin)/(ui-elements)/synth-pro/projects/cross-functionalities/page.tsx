...
const mockProject = {
  ...
  activities: [
    ...
    {
      id: 2,
      title: "Common Components Mapping", 
  ...
  documents: [
    ...
    {
      id: 2,
      title: "Cross-Project Feature Matrix",
      lines: 198,
      type: "XLSX"
    },
    {
      id: 3,
      title: "Common Functionality Catalog",
      lines: 267,
      type: "DOCX"
    },
    {
      id: 4,
      title: "Foundational Components Guide",
      lines: 145,
      type: "DOCX"
    }
  ]
...
// Icons (same as other project pages)
const ArrowLeftIcon = () => (
