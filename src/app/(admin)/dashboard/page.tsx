          ...
          <div className="flex items-start justify-between">
            ...
            <div className="relative group flex-shrink-0 ml-6">
              ...
              <div className="absolute bottom-full right-0 mb-3 w-80 bg-gray-900 dark:bg-gray-700 text-white text-sm rounded-lg p-4 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">
                <div className="font-semibold text-purple-300 mb-2">📊 Ask Adora for Dashboard Insights</div>
                <div className="space-y-2 text-xs">
                  <div><strong>Analyze:</strong> "Explain this chart" or "What's driving these trends?"</div>
                  <div><strong>Customize:</strong> "Add a revenue widget" or "Change chart colors"</div>
                  <div><strong>Compare:</strong> "Show year-over-year growth" or "Compare performance"</div>
                  <div><strong>Export:</strong> "Generate PDF report" or "Schedule weekly summary"</div>
                </div>
