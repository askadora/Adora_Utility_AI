          ...
          <div className="flex items-start justify-between">
            ...
            <div className="relative group flex-shrink-0 ml-6">
              ...
              <div className="absolute bottom-full right-0 mb-3 w-80 bg-gray-900 dark:bg-gray-700 text-white text-sm rounded-lg p-4 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">
                <div className="font-semibold text-purple-300 mb-2">💰 Ask Adora for Financial Insights</div>
                <div className="space-y-2 text-xs">
                  <div><strong>Portfolio:</strong> "Analyze my asset allocation" or "Recommend rebalancing"</div>
                  <div><strong>Risk:</strong> "Calculate portfolio risk" or "Show risk metrics"</div>
                  <div><strong>Performance:</strong> "Compare YTD returns" or "Generate performance report"</div>
                  <div><strong>Compliance:</strong> "Check regulatory requirements" or "Run compliance audit"</div>
                </div>
