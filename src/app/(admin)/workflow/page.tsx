            ...
            <div className="flex items-center gap-4 flex-shrink-0 ml-6">
              ...
              <div className="relative group">
                ...
                <div className="absolute bottom-full right-0 mb-3 w-80 bg-gray-900 dark:bg-gray-700 text-white text-sm rounded-lg p-4 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">
                  <div className="font-semibold text-purple-300 mb-2">🎤 Ask Adora for Workflow Help</div>
                  <div className="space-y-2 text-xs">
                    <div><strong>Create:</strong> "Build a customer onboarding workflow" or "Create email automation"</div>
                    <div><strong>Optimize:</strong> "How can I improve this workflow?" or "Find bottlenecks"</div>
                    <div><strong>Templates:</strong> "Show me CRM workflows" or "Find marketing templates"</div>
                    <div><strong>Troubleshoot:</strong> "Why isn't my workflow triggering?" or "Debug failed steps"</div>
                  </div>
